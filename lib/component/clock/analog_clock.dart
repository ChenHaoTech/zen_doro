...
import 'package:flutter_pasteboard/component/clock/analog_clock_painter.dart';
...
class _AnalogClockState extends State<AnalogClock> {
  ...
  initState() {
    ...
    updateDuration = widget.showSecondHand || widget.showDigitalClock ? Duration(seconds: 1) : Duration(minutes: 1);
              ...
              child: new Container(
                  ...
                  child: new CustomPaint(
                    painter: new AnalogClockPainter(
                        datetime: datetime,
                        digitalClockContext: widget.digitalClockContext,
