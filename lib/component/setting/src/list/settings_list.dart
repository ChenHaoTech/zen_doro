...
import 'package:flutter_pasteboard/component/setting/src/utils/theme_provider.dart';
        ...
        builder: (context, layout) {
          return SettingsTheme(
            ...
            child: SingleChildScrollView(
              ...
              padding: contentPadding ?? calculateDefaultPadding(platform, layout.maxWidth),
              child: Column(
                children: sections,
