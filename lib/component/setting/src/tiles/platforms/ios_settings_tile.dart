...
class IOSSettingsTileState extends State<IOSSettingsTile> {
  ...
  Widget buildTileContent(
    ...
    return GestureDetector(
      ...
      child: Container(
        color: widget.backgroundColor ?? (isPressed ? theme.themeData.tileHighlightColor : theme.themeData.settingsSectionBackground),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.only(
                                  top: widget.description != null && widget.descriptionInline ? 6 : 12.5 * scaleFactor,
                                  bottom: widget.description != null && widget.descriptionInline ? 3 : 12.5 * scaleFactor,
                                ),
                                child: DefaultTextStyle(
                                  style: TextStyle(
                  ...
                  if ((widget.description == null || widget.descriptionInline) && additionalInfo.needToShowDivider)
                    Divider(
                      height: 0,
                      thickness: 0.7,
