...
class _ErrorStackDebugWidget extends State<ErrorStackDebugWidget> {
  ...
  String className() {
    ...
    String result = className.replaceAll(pattern, "/").replaceAll("(", "").replaceAll(")", "");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: _themeMode == "light" ? Colors.white : _hexColor("#282c34"),
      body: SafeArea(
          child: Center(
        child: ListView(
          shrinkWrap: true,
                ...
                children: [
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Error Occurred!',
                            style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold, color: _themeMode == "light" ? Colors.black : Colors.white),
                          ),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: _themeMode == "light" ? Colors.grey.shade100 : _hexColor("#13151a"),
                            ),
                            child: Column(
                              children: [
                                Container(
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(8.0),
                                    color: _themeMode == 'light' ? _hexColor("#282c34") : Colors.white.withOpacity(0.2),
                                  ),
                                  child: Padding(
                                ...
                                ).easyTap(onTap: () => _copy(context, widget.errorDetails.exceptionAsString())),
                              ],
                            ),
                          ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                      color: _themeMode == "light" ? Colors.black54 : Colors.grey,
                                      fontSize: 14,
                                    ),
                                    textAlign: TextAlign.center,
                                  ),
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                CupertinoButton(
                                  onPressed: () {
                                    String exception = "${widget.errorDetails.exceptionAsString()}%20flutter";
                                    String encodedQuery = Uri.encodeQueryComponent(exception);

                                    launchUrl(Uri.parse("https://www.google.com/search?q=$encodedQuery"));
                                  },
                                  child: Text(
                                    "Search Google for this error",
                                    style: TextStyle(
                                      fontWeight: FontWeight.w600,
                                      color: _themeMode == "light" ? _hexColor("#0045a0") : Colors.white,
                                    ),
                                  ),
                                ),
                              ],
                          ...
                          TextButton(
                            ...
                            child: Text(
                              "Restart app",
                              style: TextStyle(
                                color: _themeMode == "light" ? Colors.grey : Colors.white,
                              ),
                            ),
                          ),
                        ],
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                        ...
                        icon: Icon(
                          _themeMode == "light" ? Icons.brightness_4 : Icons.brightness_7,
                          color: _themeMode == "light" ? Colors.black : Colors.white,
                        ),
                        onPressed: () async {
                          _themeMode == 'light' ? _themeMode = 'dark' : _themeMode = 'light';
                          await ErrorStack.instance.storage.write(key: '${ErrorStack.storageKey}_theme_mode', value: _themeMode!);
                  ...
                  Positioned(
                    ...
                    child: Text(
                      "ErrorStack v1.6.0",
                      style: TextStyle(
                        color: _themeMode == 'light' ? Colors.black54 : Colors.white70,
                        fontSize: 10,
                      ),
                      textAlign: TextAlign.center,
                    ),
  ...
  Future<Null> _copy(BuildContext context, String text) {
