...
import 'package:flutter_pasteboard/component/error_widget/widgets/error_stack_debug_widget.dart';
import 'package:flutter_pasteboard/component/error_widget/widgets/error_stack_release_widget.dart';
...
class ErrorStack {
  ...
  static init({
    ...
    ErrorStack.instance.themeMode = await ErrorStack.instance.storage.read(key: '${ErrorStack.storageKey}_theme_mode') ?? 'light';
  }

  static Widget errorWidget(FlutterErrorDetails errorDetails) {
    if (kAnyDebug) {
