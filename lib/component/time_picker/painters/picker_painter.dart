...
import 'package:flutter_pasteboard/component/time_picker/decoration/time_picker_sweep_decoration.dart';
...
class PickerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _radius = min(size.width / 2, size.height / 2) - pickerDecorator.sweepDecoration.pickerStrokeWidth;
    ...
    if (disableTimeStartAngle != null && disableTimeEndAngle != null && disabledSweepAngle != null) {
