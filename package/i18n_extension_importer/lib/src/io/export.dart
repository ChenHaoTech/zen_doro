...
Map<String, Exporter Function(dynamic)> exporters = {"pot": (s) => GettextExporter(s), "json": (s) => JsonExporter(s)};
...
class GettextExporter extends Exporter {
  ...
  Future<void> exportTo(File target) async {
    ...
    Map out = {
      "charset": "utf-8",
      "headers": {"content-type": "text/plain; charset=utf-8; nplurals=2; plural=(n != 1)"},
